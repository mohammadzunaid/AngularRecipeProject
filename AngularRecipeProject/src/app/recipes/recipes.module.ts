...
@NgModule({
    ...
    //     RecipeItemComponent, RecipeStartComponent, RecipeEditComponent,RecipesRoutingModule ],
    imports: [ReactiveFormsModule, RouterModule, RecipesRoutingModule, SharedModule]
})
